...
class Aboutyourvillage extends StatefulWidget {
  const Aboutyourvillage({super.key});

  @override
  State<Aboutyourvillage> createState() => _AboutyourvillageState();
}

class _AboutyourvillageState extends State<Aboutyourvillage> {
  bool isChecked = false;
  TextEditingController qtyController = TextEditingController();
  GlobalKey<FormState> _key = GlobalKey<FormState>();
  SpeechToText speechToText = SpeechToText();
  bool event_name = false;
  TextEditingController other_t = TextEditingController();
  bool space = false;
                          ...
                          return GestureDetector(
                                ...
                                if (event_name == true) {
                                  ...
                                  await speechToText.listen(
                                    onResult: (result) {
                                      setState(() {
                                        event_name = true;
                                        other_t.text = result.recognizedWords;
                                      });
                                    },
                                  );
                                  setState(() {});
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.only(
                                  right: 10, bottom: (space == true) ? 23 : 0),
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(5),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_key.currentState!.validate()) {
                          ...
                          param['other'] = other_t.text;
                          var resdata = await apiService.postCall(
                              'aboutvillage/addvillage', param);
                          log("${resdata}");
                          other_t.clear();
