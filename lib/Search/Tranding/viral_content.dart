...
class Viral_content extends StatefulWidget {
  Viral_content({Key? key}) : super(key: key);

  @override
  State<Viral_content> createState() => _Viral_contentState();
}

class _Viral_contentState extends State<Viral_content> {
